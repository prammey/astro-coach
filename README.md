...
detailed topic analytics, an activity calendar with streaks, and topic
mastery levels.

## Progress: activity, streaks, mastery and badges
...
- **Topic mastery (Pro):** each topic gets a level from Novice to Olympian
  based on the share of that topic's questions solved and accuracy, so
  small and large topics are equally reachable. Olympian also needs a
  full-mark FRQ where the topic has FRQs. Each card says what the next
  level needs.
