...
export default function ProfileSettingsPage() {
  ...
  const handleProfileImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      // Convert image to base64 for simplicity (in production, you'd upload to cloud storage)
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  <input
                    ...
                    className="block w-full text-sm text-gray-600 border-2 border-black rounded px-3 py-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--color-electric-blue)]"
                  />
